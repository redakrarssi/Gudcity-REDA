...
const resources = {
  en: {
    translation: {
      ...
      selectAccountTypeDesc: 'Select the type of account you want to create',
      customer: 'Customer',
      businessRole: 'Business',
      joinLoyaltyPrograms: 'For regular customers who want to join loyalty programs and earn rewards',
      createManagePrograms: 'For business owners who want to create and manage loyalty programs',
      ...
      enterBusinessPhone: 'Enter your business phone',
      ...
      'Please fill in all business details': 'Please fill in all business details',
      ...
      business: {
        ...
        // Dashboard specific missing keys
        'Create Your First Program': 'Create Your First Program',
        'Set up a loyalty program to start rewarding your customers. Create programs, set points rules, and design rewards that keep customers coming back.': 'Set up a loyalty program to start rewarding your customers. Create programs, set points rules, and design rewards that keep customers coming back.',
        'QR Scanner': 'QR Scanner',
        'Use the QR scanner to enroll customers in your programs and award points instantly. Scan customer QR codes to manage their loyalty journey.': 'Use the QR scanner to enroll customers in your programs and award points instantly. Scan customer QR codes to manage their loyalty journey.',
        'Create Promotions': 'Create Promotions',
        'Design and launch special offers, discounts, and seasonal campaigns to attract more customers and increase engagement.': 'Design and launch special offers, discounts, and seasonal campaigns to attract more customers and increase engagement.',
        'Manage Customers': 'Manage Customers',
        'View customer profiles, track their loyalty progress, manage their accounts, and analyze customer behavior patterns.': 'View customer profiles, track their loyalty progress, manage their accounts, and analyze customer behavior patterns.',
        'Analytics & Insights': 'Analytics & Insights',
        'Get detailed insights into your loyalty program performance, customer engagement metrics, and business growth analytics.': 'Get detailed insights into your loyalty program performance, customer engagement metrics, and business growth analytics.',
        'Welcome back! Manage your loyalty programs and grow your business.': 'Welcome back! Manage your loyalty programs and grow your business.',
        'Currency': 'Currency',
        'Other...': 'Other...',
        'Complete Your Business Profile': 'Complete Your Business Profile',
        'Your business information is incomplete. Complete your profile to unlock all features and provide better service to your customers.': 'Your business information is incomplete. Complete your profile to unlock all features and provide better service to your customers.',
        'Total Programs': 'Total Programs',
        'Get Started in 5 Simple Steps': 'Get Started in 5 Simple Steps',
        'Follow these steps to set up your loyalty program and start growing your business': 'Follow these steps to set up your loyalty program and start growing your business',
        'Get Started': 'Get Started',
        'Need Help Getting Started?': 'Need Help Getting Started?',
        'Our comprehensive guides and support team are here to help you make the most of your loyalty program.': 'Our comprehensive guides and support team are here to help you make the most of your loyalty program.',
        'View Settings': 'View Settings',
        'View Help Center': 'View Help Center',
  ...
  ar: {
    translation: {
      ...
      enterBusinessDetails: 'أدخل تفاصيل العمل',
      security: 'الأمان',
      setupSecurity: 'إعداد الأمان',
      chooseYourRole: 'اختر دورك',
      selectAccountTypeDesc: 'اختر نوع الحساب الذي تريد إنشاءه',
      customer: 'عميل',
      businessRole: 'عمل',
      joinLoyaltyPrograms: 'للعملاء العاديين الذين يريدون الانضمام لبرامج الولاء والحصول على المكافآت',
      createManagePrograms: 'لأصحاب الأعمال الذين يريدون إنشاء وإدارة برامج الولاء',
      ...
      enterBusinessPhone: 'أدخل هاتف عملك',
      securitySetup: 'إعداد الأمان',
      createSecurePassword: 'أنشئ كلمة مرور آمنة لحسابك',
      ...
      'Please fill in all business details': 'يرجى ملء جميع تفاصيل العمل',
      ...
      business: {
        ...
        // Dashboard specific missing keys
        'Create Your First Program': 'أنشئ برنامجك الأول',
        'Set up a loyalty program to start rewarding your customers. Create programs, set points rules, and design rewards that keep customers coming back.': 'قم بإعداد برنامج ولاء لمكافأة عملائك. أنشئ البرامج، وحدد قواعد النقاط، وصمم المكافآت التي تجعل العملاء يعودون.',
        'QR Scanner': 'ماسح QR',
        'Use the QR scanner to enroll customers in your programs and award points instantly. Scan customer QR codes to manage their loyalty journey.': 'استخدم ماسح QR لتسجيل العملاء في برامجك ومنح النقاط فوراً. امسح رموز QR للعملاء لإدارة رحلة ولائهم.',
        'Create Promotions': 'إنشاء العروض الترويجية',
        'Design and launch special offers, discounts, and seasonal campaigns to attract more customers and increase engagement.': 'صمم وأطلق عروض خاصة وخصومات وحملات موسمية لجذب المزيد من العملاء وزيادة التفاعل.',
        'Manage Customers': 'إدارة العملاء',
        'View customer profiles, track their loyalty progress, manage their accounts, and analyze customer behavior patterns.': 'عرض ملفات العملاء الشخصية، وتتبع تقدم ولائهم، وإدارة حساباتهم، وتحليل أنماط سلوك العملاء.',
        'Analytics & Insights': 'التحليلات والرؤى',
        'Get detailed insights into your loyalty program performance, customer engagement metrics, and business growth analytics.': 'احصل على رؤى مفصلة حول أداء برنامج الولاء الخاص بك، ومقاييس تفاعل العملاء، وتحليلات نمو الأعمال.',
        'Welcome back! Manage your loyalty programs and grow your business.': 'مرحباً بعودتك! أدر برامج الولاء الخاصة بك ونمِ عملك.',
        'Currency': 'العملة',
        'Other...': 'أخرى...',
        'Complete Your Business Profile': 'أكمل ملف شركتك الشخصي',
        'Your business information is incomplete. Complete your profile to unlock all features and provide better service to your customers.': 'معلومات شركتك غير مكتملة. أكمل ملفك الشخصي لفتح جميع الميزات وتقديم خدمة أفضل لعملائك.',
        'Total Programs': 'إجمالي البرامج',
        'Get Started in 5 Simple Steps': 'ابدأ في 5 خطوات بسيطة',
        'Follow these steps to set up your loyalty program and start growing your business': 'اتبع هذه الخطوات لإعداد برنامج الولاء الخاص بك وبدء نمو عملك',
        'Get Started': 'ابدأ الآن',
        'Need Help Getting Started?': 'تحتاج مساعدة للبدء؟',
        'Our comprehensive guides and support team are here to help you make the most of your loyalty program.': 'أدلةنا الشاملة وفريق الدعم هنا لمساعدتك في الاستفادة القصوى من برنامج الولاء الخاص بك.',
        'View Settings': 'عرض الإعدادات',
        'View Help Center': 'عرض مركز المساعدة',
  ...
  es: {
    translation: {
      ...
      enterBusinessDetails: 'Ingresa detalles del negocio',
      security: 'Seguridad',
      setupSecurity: 'Configurar seguridad',
      chooseYourRole: 'Elige Tu Rol',
      selectAccountTypeDesc: 'Selecciona el tipo de cuenta que quieres crear',
      customer: 'Cliente',
      businessRole: 'Negocio',
      joinLoyaltyPrograms: 'Para clientes regulares que quieren unirse a programas de lealtad y ganar recompensas',
      createManagePrograms: 'Para dueños de negocios que quieren crear y gestionar programas de lealtad',
      ...
      tellUsAboutBusiness: 'Cuéntanos sobre tu negocio',
      businessName: 'Nombre del Negocio',
      enterBusinessName: 'Ingresa el nombre de tu negocio',
      businessPhone: 'Teléfono del Negocio',
      enterBusinessPhone: 'Ingresa el teléfono de tu negocio',
      securitySetup: 'Configuración de Seguridad',
      createSecurePassword: 'Crea una contraseña segura para tu cuenta',
      ...
      'Please fill in all business details': 'Por favor completa todos los detalles del negocio',
      'Passwords do not match': 'Las contraseñas no coinciden',
      'Password must be at least 6 characters': 'La contraseña debe tener al menos 6 caracteres',
      'Please accept the terms and conditions': 'Por favor acepta los términos y condiciones',
      'Registration failed. Please try again.': 'El registro falló. Por favor intenta de nuevo.',
      'An error occurred during registration. Please try again later.': 'Ocurrió un error durante el registro. Por favor intenta más tarde.',
      Password: 'Contraseña',
      dashboard: 'Panel',
      home: 'Inicio',
      ...
      business: {
        ...
        // Dashboard specific missing keys
        'Create Your First Program': 'Crea Tu Primer Programa',
        'Set up a loyalty program to start rewarding your customers. Create programs, set points rules, and design rewards that keep customers coming back.': 'Configura un programa de lealtad para comenzar a recompensar a tus clientes. Crea programas, establece reglas de puntos y diseña recompensas que mantengan a los clientes regresando.',
        'QR Scanner': 'Escáner QR',
        'Use the QR scanner to enroll customers in your programs and award points instantly. Scan customer QR codes to manage their loyalty journey.': 'Usa el escáner QR para inscribir clientes en tus programas y otorgar puntos al instante. Escanea códigos QR de clientes para gestionar su viaje de lealtad.',
        'Create Promotions': 'Crear Promociones',
        'Design and launch special offers, discounts, and seasonal campaigns to attract more customers and increase engagement.': 'Diseña y lanza ofertas especiales, descuentos y campañas estacionales para atraer más clientes y aumentar el compromiso.',
        'Manage Customers': 'Gestionar Clientes',
        'View customer profiles, track their loyalty progress, manage their accounts, and analyze customer behavior patterns.': 'Ve perfiles de clientes, rastrea su progreso de lealtad, gestiona sus cuentas y analiza patrones de comportamiento del cliente.',
        'Analytics & Insights': 'Análisis y Perspectivas',
        'Get detailed insights into your loyalty program performance, customer engagement metrics, and business growth analytics.': 'Obtén perspectivas detalladas sobre el rendimiento de tu programa de lealtad, métricas de compromiso del cliente y análisis de crecimiento del negocio.',
        'Welcome back! Manage your loyalty programs and grow your business.': '¡Bienvenido de vuelta! Gestiona tus programas de lealtad y haz crecer tu negocio.',
        'Currency': 'Moneda',
        'Other...': 'Otro...',
        'Complete Your Business Profile': 'Completa Tu Perfil de Negocio',
        'Your business information is incomplete. Complete your profile to unlock all features and provide better service to your customers.': 'La información de tu negocio está incompleta. Completa tu perfil para desbloquear todas las funciones y brindar mejor servicio a tus clientes.',
        'Total Programs': 'Total de Programas',
        'Get Started in 5 Simple Steps': 'Comienza en 5 Pasos Simples',
        'Follow these steps to set up your loyalty program and start growing your business': 'Sigue estos pasos para configurar tu programa de lealtad y comenzar a hacer crecer tu negocio',
        'Get Started': 'Comenzar',
        'Need Help Getting Started?': '¿Necesitas Ayuda para Comenzar?',
        'Our comprehensive guides and support team are here to help you make the most of your loyalty program.': 'Nuestras guías completas y equipo de soporte están aquí para ayudarte a aprovechar al máximo tu programa de lealtad.',
        'View Settings': 'Ver Configuración',
        'View Help Center': 'Ver Centro de Ayuda',
  ...
  fr: {
    translation: {
      ...
      enterBusinessDetails: 'Entrez les détails de l\'entreprise',
      security: 'Sécurité',
      setupSecurity: 'Configurer la sécurité',
      chooseYourRole: 'Choisissez Votre Rôle',
      selectAccountTypeDesc: 'Sélectionnez le type de compte que vous voulez créer',
      customer: 'Client',
      businessRole: 'Entreprise',
      joinLoyaltyPrograms: 'Pour les clients réguliers qui veulent rejoindre les programmes de fidélité et gagner des récompenses',
      createManagePrograms: 'Pour les propriétaires d\'entreprise qui veulent créer et gérer des programmes de fidélité',
      ...
      enterBusinessPhone: 'Entrez le téléphone de votre entreprise',
      securitySetup: 'Configuration de la Sécurité',
      createSecurePassword: 'Créez un mot de passe sécurisé pour votre compte',
      ...
      'Please fill in all business details': 'Veuillez remplir tous les détails de l\'entreprise',
      'Passwords do not match': 'Les mots de passe ne correspondent pas',
      'Password must be at least 6 characters': 'Le mot de passe doit contenir au moins 6 caractères',
      'Please accept the terms and conditions': 'Veuillez accepter les termes et conditions',
      'Registration failed. Please try again.': 'L\'inscription a échoué. Veuillez réessayer.',
      'An error occurred during registration. Please try again later.': 'Une erreur s\'est produite lors de l\'inscription. Veuillez réessayer plus tard.',
      ...
      business: {
        ...
        // Dashboard specific missing keys
        'Create Your First Program': 'Créez Votre Premier Programme',
        'Set up a loyalty program to start rewarding your customers. Create programs, set points rules, and design rewards that keep customers coming back.': 'Configurez un programme de fidélité pour commencer à récompenser vos clients. Créez des programmes, définissez des règles de points et concevez des récompenses qui font revenir les clients.',
        'QR Scanner': 'Scanner QR',
        'Use the QR scanner to enroll customers in your programs and award points instantly. Scan customer QR codes to manage their loyalty journey.': 'Utilisez le scanner QR pour inscrire les clients à vos programmes et attribuer des points instantanément. Scannez les codes QR des clients pour gérer leur parcours de fidélité.',
        'Create Promotions': 'Créer des Promotions',
        'Design and launch special offers, discounts, and seasonal campaigns to attract more customers and increase engagement.': 'Concevez et lancez des offres spéciales, des remises et des campagnes saisonnières pour attirer plus de clients et augmenter l\'engagement.',
        'Manage Customers': 'Gérer les Clients',
        'View customer profiles, track their loyalty progress, manage their accounts, and analyze customer behavior patterns.': 'Consultez les profils clients, suivez leur progression de fidélité, gérez leurs comptes et analysez les modèles de comportement des clients.',
        'Analytics & Insights': 'Analyses et Perspectives',
        'Get detailed insights into your loyalty program performance, customer engagement metrics, and business growth analytics.': 'Obtenez des perspectives détaillées sur les performances de votre programme de fidélité, les métriques d\'engagement client et les analyses de croissance de l\'entreprise.',
        'Welcome back! Manage your loyalty programs and grow your business.': 'Bon retour ! Gérez vos programmes de fidélité et développez votre entreprise.',
        'Currency': 'Devise',
        'Other...': 'Autre...',
        'Complete Your Business Profile': 'Complétez Votre Profil d\'Entreprise',
        'Your business information is incomplete. Complete your profile to unlock all features and provide better service to your customers.': 'Les informations de votre entreprise sont incomplètes. Complétez votre profil pour débloquer toutes les fonctionnalités et offrir un meilleur service à vos clients.',
        'Total Programs': 'Total des Programmes',
        'Get Started in 5 Simple Steps': 'Commencez en 5 Étapes Simples',
        'Follow these steps to set up your loyalty program and start growing your business': 'Suivez ces étapes pour configurer votre programme de fidélité et commencer à développer votre entreprise',
        'Get Started': 'Commencer',
        'Need Help Getting Started?': 'Besoin d\'Aide pour Commencer ?',
        'Our comprehensive guides and support team are here to help you make the most of your loyalty program.': 'Nos guides complets et équipe de support sont là pour vous aider à tirer le meilleur parti de votre programme de fidélité.',
        'View Settings': 'Voir les Paramètres',
        'View Help Center': 'Voir le Centre d\'Aide',
