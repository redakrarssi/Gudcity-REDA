  ...
  ar: {
    translation: {
      ...
      business: {
        ...
        'Failed to delete program. Please try again.': 'فشل في حذف البرنامج. يرجى المحاولة مرة أخرى.',
        'An error occurred while deleting the program.': 'حدث خطأ أثناء حذف البرنامج.',
        'Could not create program: Missing business information': 'لا يمكن إنشاء البرنامج: معلومات العمل مفقودة',
        'Could not connect to database. Please try again later.': 'لا يمكن الاتصال بقاعدة البيانات. يرجى المحاولة لاحقاً.',
        'Program creation failed - check console for details': 'فشل إنشاء البرنامج - تحقق من وحدة التحكم للتفاصيل',
        'Error creating program: {{error}}': 'خطأ في إنشاء البرنامج: {{error}}',
        'An error occurred': 'حدث خطأ',
        'Delete': 'حذف',
        'Edit': 'تعديل',
        '{{value}} = 1 point': '{{value}} = نقطة واحدة',
        '1 stamp per visit': 'ختم واحد لكل زيارة',
        'Points expire after {{days}} days': 'تنتهي النقاط بعد {{days}} أيام',
        'Never expires': 'لا تنتهي أبداً',
        'Reward Tiers': 'مستويات المكافآت',
        'points': 'نقاط',
        'stamps': 'أختام',
  ...
  es: {
    translation: {
      ...
      business: {
        ...
        'Create New Loyalty Program': 'Crear Nuevo Programa de Lealtad',
        'Edit Loyalty Program': 'Editar Programa de Lealtad',
        'Failed to load loyalty programs. Please try again.': 'Error al cargar programas de lealtad. Por favor inténtalo de nuevo.',
        'Failed to delete program. Please try again.': 'Error al eliminar programa. Por favor inténtalo de nuevo.',
        'An error occurred while deleting the program.': 'Ocurrió un error al eliminar el programa.',
        'Could not create program: Missing business information': 'No se pudo crear el programa: Información del negocio faltante',
        'Could not connect to database. Please try again later.': 'No se pudo conectar a la base de datos. Por favor inténtalo más tarde.',
        'Program creation failed - check console for details': 'Falló la creación del programa - revisa la consola para detalles',
        'Error creating program: {{error}}': 'Error creando programa: {{error}}',
        'An error occurred': 'Ocurrió un error',
        'Delete': 'Eliminar',
        'Edit': 'Editar',
        '{{value}} = 1 point': '{{value}} = 1 punto',
        ...
        'stamps': 'sellos',
        'No Programs Found': 'No se Encontraron Programas',
        'You haven\'t created any loyalty programs yet. Create your first program to start rewarding your customers.': 'Aún no has creado ningún programa de lealtad. Crea tu primer programa para comenzar a recompensar a tus clientes.',
