...
async function main() {
  try {
    console.log('Checking business_profile table structure and data...');
    ...
    console.log(`\nFound ${records.rows.length} records in business_profile table:`);
    console.log(JSON.stringify(records.rows, null, 2));
    
    // Get connected users for these business profiles
