...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  const { businessId, type } = req.query as { businessId?: string; type?: string };
  ...
  try {
    ...
    // growth/segments can be added later; return basic counts for now
    ...
    console.error('Customers analytics error:', e);
