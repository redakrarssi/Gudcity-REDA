/**
 * Customer Programs API Endpoint
 * GET /api/customers/[id]/programs - Get programs a customer is enrolled in
 */
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  console.log('🔍 [Customer Programs] Request received:', { 
    method: req.method,
    url: req.url,
  ...
  try {
    if (req.method === 'GET') {
      ...
      // Authorization check - users can only access their own programs unless admin/business
