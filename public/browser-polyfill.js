...
(function() {
  console.log('Loading complete browser polyfill');
  // Create a browser polyfill if it doesn't exist or extend existing one
...
(function() {
  console.log('Loading browser polyfill - second pass');
  
  // Create browser global if it doesn't exist or extend it
  if (typeof window !== 'undefined') {
    // Make sure browser exists as a global, but don't replace it
